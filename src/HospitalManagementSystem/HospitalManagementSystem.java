...
public class HospitalManagementSystem {
    ...
    private static final String password = "Shivam@123";
        ...
        try{
            ...
            Doctors doctors = new Doctors(connection);
                    while(true){
                        ...
                        System.out.println("4. Book Apointemnet");
    ...
    public static void bookAppointment(Patient patient, Doctors doctors, Connection connection,Scanner scanner ){
        ...
        }else if(patient.getPatientById(patientId)){
            System.out.println("Doctor doesn't exist.");
        }else if (doctors.getDoctorsById(doctorId)){
            System.out.println("Patirnt doesn't exist.");
        }else {
            System.out.println("Doctors & Patients both doesn't exists.");
        }
